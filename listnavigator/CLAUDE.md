...
List Navigator is a Firefox browser extension that enables universal search and navigation through webpage elements using CSS selectors. It provides a draggable search panel with keyboard shortcuts and visual highlighting to find and navigate content on any website.
...
- `<all_urls>` - Ability to run on any website (universal functionality)
...
- **manifest.json** line 4: `"version": "0.1.11"`
- **content.js** line 33: Display in panel header
